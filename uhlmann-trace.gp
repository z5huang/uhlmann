...
p wdat u ($2/pi):($4/pi - 2*$5) w l lt -1 notit, \
  ...
  udat u ($2/pi):($8/pi) w p lc 1 pt 4  tit '$\gamma_{tr}$', \
  udat u ($2/pi):($8/pi - 2 + 0.0001) w p lc 1 pt 4 notit
...
p udat u ($2/pi):7 axes x1y2 w l lc 1 tit '$w_{tr}$'
unset multiplot
#
###
